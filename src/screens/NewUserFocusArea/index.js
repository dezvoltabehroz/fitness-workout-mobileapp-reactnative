            ...
            <Container>
                ...
                <ImageBackground resizeMode={"cover"} source={require('../../assets/images/bg.png')} style={styles.bgStyle}>
                    ...
                    <View style={styles.container}>
                        ...
                        <ImageBackground style={gender == 'male' ? styles.imageStyle : styles.imageStyleGirl} resizeMode="contain" source={gender == 'male' ? require('../../assets/images/male.jpeg') : require('../../assets/images/female.jpeg')}>
                            {
                                gender == 'male' ?
                                    <>
