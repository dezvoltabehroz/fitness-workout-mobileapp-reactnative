            ...
            <View style={styles.itemContainer} >
                ...
                {item.expanded ?
                    item.workoutDays.map((element, inde) => {
                        let time = moment.duration(element.total_time).asSeconds();
                        var h = time / 3600 | 0;
                        var m = time % 3600 / 60 | 0;
                        var s = time % 3600 % 60 | 0;
                            ...
                            <TouchableOpacity disabled={moment().format('YYYY-MM-DD') >= moment(element.date).format("YYYY-MM-DD") ? false : true} onPress={() => {
                                ...
                                <View style={styles.textContainer1}>
                                    ...
                                    <View style={styles.rowContainer1}>
                                        <View style={[styles.row, { flex: 1 }]}>
                                            <Text style={{ ...styles.dayText1, width: 50 }}>{this.truncateString(element.day, 3)}</Text>
                                            <View style={{ flex: 1 }}>
                                                <View style={[styles.row, { flex: 0.5, marginLeft: 10 }]}>
                                                    <Stopwatch />
                                                    <Text style={[styles.greyText, { marginLeft: 10 }]}>
                                                        ...
                                                        {timeInHour[6] == 0 && timeInHour[7] == 0 ? "" : ` ${timeInHour[6]}${timeInHour[7]}`}
                                                        {
                                                            timeInHour[6] == 0 && timeInHour[7] == 0 ?
                                                                '0 Sec'
                                                                :
                                                                ' Sec '
                                                        }
