...
class SelectEuipment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            timer: false,
        ...
        return (
            <ColorContainer>
                ...
                <View style={styles.buttonContainer}>
                    <ClearButton title={screen.NEXT} onPress={() => navigate(route.FOCUSAREA)} />
                </View>
            </ColorContainer>
...
export default connect(mapStateToProps)(SelectEuipment);