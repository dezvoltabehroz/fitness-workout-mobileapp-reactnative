            ...
            <Container>
                ...
                <ImageBackground resizeMode={"cover"} source={require('../../assets/images/bg.png')} style={styles.bgStyle}>
                    ...
                    <View style={styles.container}>
                        ...
                        <ImageBackground style={this.props.route?.params?.gender == 'Male' ? styles.imageStyle : styles.imageStyleGirl} resizeMode="contain" source={this.props.route?.params?.gender == 'Male' ? require('../../assets/images/male.jpeg') : require('../../assets/images/female.png')}>
                            {
