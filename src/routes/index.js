...
import { AuthLoading, PaymentMethod, DaysWorkout, DaysWorkoutVideos, DayWorkoutVideoPlayer, PowerOfMindAudio, DietPlan, CompleteProfile, ProgressPics, Login, SelectEuipment, FocusArea, UpdatingPlan, FitnessGoal, FitnessLevel, AppIntroZero, FeedBack, Video, WorkoutSettings, AppIntro4th, GenerateUserWithEmailPassword, GifScreen, ChangeFocusArea, ImportantNote } from '../screens';
    ...
    return (
        <Stack.Navigator initialRouteName={route.AUTH_LOADING} >
            ...
            <Stack.Screen name={route.GIFSCREEN} component={GifScreen} options={({ navigation, route }) => ({
             ...
             <Stack.Screen name={route.CHANGEFOCUSAREA} component={ChangeFocusArea} options={({ navigation, route }) => ({
                headerBackTitleVisible: false,
              ...
              <Stack.Screen name={route.IMPORTANTNOTE} component={ImportantNote} options={({ navigation, route }) => ({
                headerBackTitleVisible: false,
            ...
            <Stack.Screen name={route.WORKOUTSETTINGS} component={WorkoutSettings} options={({ navigation, route }) => ({
                headerLeft: () => (<HeaderLeft navigation={navigation} color />),
                tabBarVisible: false,
                headerTitle: "Workout Settings",
                headerStyle: styles.headerStyle1,
                headerTintColor: THEME.COLOR_WHITE,
                headerTitleStyle: styles.headerTextStyle,
            })} />
            <Stack.Screen name={route.VIDEO} component={Video} options={({ navigation, route }) => ({
                headerLeft: () => (<HeaderLeft navigation={navigation} color />),
                tabBarVisible: false,
                headerTitle: 'Video',
                headerStyle: styles.headerStyle1,
